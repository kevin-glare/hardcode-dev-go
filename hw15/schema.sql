...
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS actors_films_actor_id_idx ON actors_films(actor_id);
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS actors_films_film_id_idx ON actors_films(film_id);
...
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS directors_films_director_id_idx ON directors_films(director_id);
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS directors_films_film_id_idx ON directors_films(film_id);