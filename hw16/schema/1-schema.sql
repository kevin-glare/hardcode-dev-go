...
CREATE INDEX CONCURRENTLY IF NOT EXISTS films_studio_idx ON films(studio_id);
...
CREATE TABLE actors_films (
    ...
    film_id BIGINT NOT NULL REFERENCES films(id) ON DELETE CASCADE ON UPDATE CASCADE DEFAULT 0,
